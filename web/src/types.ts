...
export interface Server { id: string; name: string; hostname: string; status: string; agent_version: string; agent_target_version: string; agent_update_available: boolean; agent_update_supported: boolean; codex_version: string; codex_ready: number; codex_target_version: string; codex_update_available: boolean; codex_update_supported: boolean; address: string; configuration: string; notes: string; codex_profile_id: string; codex_profile_name: string; git_profile_id: string; git_profile_name: string; last_seen_at: string | null; created_at: string }
