...
export interface Deployment { id: string; target_id: string; operation_id: string; commit_ref: string; resolved_commit: string; status: string; message: string; project_name: string; environment: string; public_url: string; created_at: string; started_at: string | null; finished_at: string | null }
