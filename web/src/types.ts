...
export interface Server { id: string; name: string; hostname: string; status: string; agent_version: string; codex_version: string; codex_ready: number; address: string; configuration: string; notes: string; last_seen_at: string | null; created_at: string }
