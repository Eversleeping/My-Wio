...
export function DeploymentsPage({ realtime, notify }: PageProps) {
  ...
  const emptyForm = { project_id: "", server_id: "", secret_set_id: "", environment: "production", repository: "", git_ref: "main", compose_file: "compose.yaml", working_dir: "", build_mode: "build", release_root: "/var/lib/wio-agent/releases", health: "" };
  ...
  const openEdit = (target: DeploymentTarget) => {
    ...
    setForm({ project_id: target.project_id, server_id: target.server_id, secret_set_id: target.secret_set_id, environment: target.environment, repository: target.repository, git_ref: target.git_ref, compose_file: target.compose_file, working_dir: target.working_dir, build_mode: target.build_mode, release_root: target.release_root, health });
