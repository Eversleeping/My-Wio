...
export function WorkspaceGitDialog({ open, snapshot, loading, busy: requestBusy, error, labels, Dialog, onClose, onRefresh, onAction }: {
  open: boolean;
